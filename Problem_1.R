...
## e)
## The intercept is positive which shows that if no women are involved in housework the work that will be 
## done by all men is the average value of work hours by men per week
...
## f)
## We are able to rewrite the null hypothesis to be: H0 beta1 >= 0
## in this case, the alternative hypothesis would be: H1 beta1 < 0
## This suggests that the null hypothesis states that women's work hours contribute to the average population work hours
...
## h)
##There is almost a zero probability for us to make a mistake when rejecting the 
##null hypothesis if it is true. This means that we can reject the null hypothesis.
